...
.slide1 {
  background: url('@/assets/images/slider/4.jpg') center center/cover no-repeat
    local;
}
...
.slide3 {
  background: url('@/assets/images/slider/3.jpg') center center/cover no-repeat
    local;
}
...
.hero-style-3 .slide-caption p span {
  color: #c1b696;
}
